import { e as LRParser, E as ExternalTokenizer, h as LocalTokenGroup, C as ContextTracker, s as styleTags, t as tags, a as LanguageSupport, b as ifNotIn, d as completeFromList, L as LRLanguage, i as indentNodeProp, j as flatIndent, c as continuedIndent, k as delimitedIndent, f as foldNodeProp, l as foldInside, g as syntaxTree, m as snippetCompletion, N as NodeWeakMap, I as IterMode } from './markdown-KDAvIZPL.js';
...
const semicolon = new ExternalTokenizer((input, stack) => {
  for (let scan = 0, next = input.next;;) {
    if (
      stack.context && (next < 0 || next == newline || next == carriageReturn ||
...
const parser = LRParser.deserialize({
  ...
  tokenizers: [
    ...
    1,
    2,
    new LocalTokenGroup("j~RQYZXz{^~^O$|~~aP!P!Qd~iO$}~~", 25, 181),
  ],
...
const snippets = [
  ...
  /*@__PURE__*/ snippetCompletion(
    "func (${receiver}) ${name}(${params}) ${type} {\n\t${}\n}",
    {
      label: "func",
  ...
  parser: /*@__PURE__*/ parser.configure({
    props: [
      ...
      /*@__PURE__*/ foldNodeProp.add({
        "Block SwitchBlock SelectBlock LiteralValue InterfaceType StructType SpecList":
          foldInside,
        BlockComment(tree) {
...
const keywords =
  /*@__PURE__*/ "interface struct chan map package go return break continue goto fallthrough else defer range true false nil"
    .split(" ").map(kwCompletion);
/**

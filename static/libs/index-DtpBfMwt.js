import { L as LRLanguage, a as LanguageSupport, p as html, q as parseMixed, v as javascriptLanguage, s as styleTags, t as tags, e as LRParser, E as ExternalTokenizer } from './markdown-CHk9_O5A.js';
...
const text = /*@__PURE__*/ new ExternalTokenizer((input) => {
  ...
  for (;;) {
    if (input.next == 10 /* Ch.Newline */) {
      ...
      input.next == 123 /* Ch.BraceL */ &&
        input.peek(1) == 123 /* Ch.BraceL */ || input.next < 0
    ) {
      break;
    }
    input.advance();
...
function attrContent(quote, token, script) {
  return new ExternalTokenizer((input) => {
    ...
    while (
      ...
      (script ||
        input.next != 38 /* Ch.Ampersand */ &&
          (input.next != 123 /* Ch.BraceL */ ||
            input.peek(1) != 123 /* Ch.BraceL */))
    ) {
      input.advance();
    }
    if (input.pos > start) {
...
const attrSingle = /*@__PURE__*/ attrContent(
  39, /* Ch.SingleQuote */
  attributeContentSingle,
  false,
);
const attrDouble = /*@__PURE__*/ attrContent(
  34, /* Ch.DoubleQuote */
  attributeContentDouble,
  false,
);
const scriptAttrSingle = /*@__PURE__*/ attrContent(
  39, /* Ch.SingleQuote */
  scriptAttributeContentSingle,
  true,
);
const scriptAttrDouble = /*@__PURE__*/ attrContent(
  34, /* Ch.DoubleQuote */
...
function angular(config = {}) {
  ...
  return new LanguageSupport(
    base.language == baseHTML.language
      ? angularLanguage
      : mkAngular(base.language),
    [
      base.support,

import { e as LRParser, E as ExternalTokenizer, s as styleTags, t as tags, a as LanguageSupport, L as LRLanguage, i as indentNodeProp, c as continuedIndent, f as foldNodeProp, l as foldInside } from './markdown-C-aDYvwT.js';
  ...
  if (isNum(input.next)) {
    ...
    if (input.next == Dot) {
      ...
      if (isNum(input.next)) {
        ...
        input.next == Dot || input.next > 0x7f ||

import { e as LRParser, E as ExternalTokenizer, C as ContextTracker, s as styleTags, t as tags, b as ifNotIn, g as syntaxTree, a as LanguageSupport, L as LRLanguage, i as indentNodeProp, k as delimitedIndent, f as foldNodeProp, l as foldInside, N as NodeWeakMap, I as IterMode, d as completeFromList, m as snippetCompletion } from './markdown-C4io6-Ss.js';
...
function getScope(doc, node) {
  ...
  node.cursor(IterMode.IncludeAnonymous).iterate((node) => {
    if (node.name) {
      ...
      if (
        gather && gather(node, def, top) || !top && ScopeNodes.has(node.name)
      ) {
        return false;
      }
      top = false;
...
*/
const globalCompletion = /*@__PURE__*/ ifNotIn(
  dontComplete,
  /*@__PURE__*/ completeFromList(/*@__PURE__*/ globals.concat(snippets)),
);
    ...
    props: [
      /*@__PURE__*/ indentNodeProp.add({
        Body: (context) => {
          var _a;
          let body =
            /^\s*(#|$)/.test(context.textAfter) && innerBody(context) ||
            context.node;
          return (_a = indentBody(context, body)) !== null && _a !== void 0
            ? _a
            : context.continue();
        },
        MatchBody: (context) => {
          ...
          return (_a = indentBody(context, inner || context.node)) !== null &&
              _a !== void 0
            ? _a
            : context.continue();
        },
        ...
        "ForStatement WhileStatement": (cx) =>
          /^\s*else:/.test(cx.textAfter) ? cx.baseIndent : cx.continue(),
        TryStatement: (cx) =>
          /^\s*(except[ :]|finally:|else:)/.test(cx.textAfter)
            ? cx.baseIndent
            : cx.continue(),
        MatchStatement: (cx) => {
        ...
        Script: (context) => {
          var _a;
          let inner = innerBody(context);
          return (_a = inner && indentBody(context, inner)) !== null &&
              _a !== void 0
            ? _a
            : context.continue();
        },

import { e as LRParser, E as ExternalTokenizer, C as ContextTracker, s as styleTags, t as tags, n as EditorView, g as syntaxTree, o as EditorSelection, a as LanguageSupport, L as LRLanguage, i as indentNodeProp, f as foldNodeProp, u as bracketMatchingHandle } from './markdown-D2bwluya.js';
...
function nameChar(ch) {
  return ch == 45 || ch == 46 || ch == 58 || ch >= 65 && ch <= 90 || ch == 95 ||
    ch >= 97 && ch <= 122 || ch >= 161;
}
...
const parser = LRParser.deserialize({
  ...
  goto:
    "%cxPPPPPPPPPPyyP!PP!VPP!`!jP!pyyyP!v!|#S$[$k$q$w$}%TPPPP%ZXWORYbXRORYb_t`qru!T!U!bQ!i!YS!p!e!fR!w!oQdRRybXSORYbQYORmYQ[PRn[Q_QQkVjp_krz!R!T!X!Z!^!`!f!j!oQr`QzcQ!RlQ!TqQ!XsQ!ZtQ!^{Q!`!QQ!f!YQ!j!]R!o!eQu`S!UqrU![u!U!bR!b!TQ!r!gR!x!rQ!u!hR!z!uQbRRxbQfTR|fQiUR!OiSXOYTaRb",
  nodeNames:
...
function findLocation(state, pos) {
  ...
  for (let cur = at; !inTag && cur.parent; cur = cur.parent) {
    if (
      cur.name == "OpenTag" || cur.name == "CloseTag" ||
      cur.name == "SelfClosingTag" || cur.name == "MismatchedCloseTag"
    ) {
      inTag = cur;
    }
  }
  if (inTag && (inTag.to > pos || inTag.lastChild.type.isError)) {
    ...
    let before = at == inTag || at.name == "Attribute"
      ? at.childBefore(pos)
      : at;
    if (
      (before === null || before === void 0 ? void 0 : before.name) ==
        "StartTag"
    ) {
  ...
  while (
    at.parent && at.to == pos &&
    !((_a = at.lastChild) === null || _a === void 0 ? void 0 : _a.type.isError)
  ) {
    at = at.parent;
  }
...
class Element {
  constructor(spec, attrs, attrValues) {
    ...
    this.children = [];
    this.name = spec.name;
    this.completion = Object.assign(
      Object.assign({ type: "type" }, spec.completion || {}),
      { label: this.name },
    );
    ...
    this.closeNameCompletion = Object.assign(
...
function attrCompletion(spec) {
  return Object.assign(
    Object.assign({ type: "property" }, spec.completion || {}),
    { label: spec.name },
  );
}
    ...
    if (type == "openTag") {
      ...
      return parentName
        ? {
          ...
          options: [
            ((_a = byName[parentName]) === null || _a === void 0
              ? void 0
              : _a.closeNameCompletion) ||
            { label: parentName + ">", type: "type" },
          ],
          validFor: Identifier,
        }
        : null;
      ...
      return {
        from,
        options:
          (parent === null || parent === void 0 ? void 0 : parent.attrs) ||
          globalAttrs,
        validFor: Identifier,
      };
      ...
      let parent = byName[tagName(doc, context)];
      let values =
        ((parent === null || parent === void 0 ? void 0 : parent.attrValues) ||
          attrValues)[attr];
      ...
      let options = closing.concat(
        ((parent === null || parent === void 0 ? void 0 : parent.children) ||
          (context ? allElements : topElements)).map((e) => e.openCompletion),
      );
      if (
        context &&
        (parent === null || parent === void 0 ? void 0 : parent.text.length)
      ) {
...
const autoCloseTags = /*@__PURE__*/ EditorView.inputHandler.of(
  (view, from, to, text, insertTransaction) => {
    if (
      view.composing || view.state.readOnly || from != to ||
      (text != ">" && text != "/") ||
    ...
    let closeTags = state.changeByRange((range) => {
      ...
      if (didType && text == ">" && after.name == "EndTag") {
        ...
        if (
          ((_b = (_a = tag.parent) === null || _a === void 0
                    ? void 0
          ...
          let to = head +
            (state.doc.sliceString(head, head + 1) === ">" ? 1 : 0);
          let insert = `</${name}>`;
        ...
        if (
          after.from == head - 2 &&
          ((_c = base.lastChild) === null || _c === void 0
              ? void 0
              : _c.name) != "CloseTag" &&

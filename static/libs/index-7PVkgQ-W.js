import { a as LanguageSupport, r as defineCSSCompletionSource, L as LRLanguage, i as indentNodeProp, c as continuedIndent, f as foldNodeProp, l as foldInside, e as LRParser, E as ExternalTokenizer, s as styleTags, t as tags } from './markdown-C4io6-Ss.js';
...
const argList = /*@__PURE__*/ new ExternalTokenizer((input, stack) => {
  if (input.next == 40 /* Ch.parenL */) {
    ...
    if (
      isAlpha(prev) || isDigit(prev) || prev == 95 /* Ch.underscore */ ||
      prev == 45 /* Ch.dash */
    ) {
...
const descendant = /*@__PURE__*/ new ExternalTokenizer((input) => {
  if (space.indexOf(input.peek(-1)) > -1) {
    let { next } = input;
    if (
      isAlpha(next) || next == 95 /* Ch.underscore */ ||
      next == 35 /* Ch.hash */ || next == 46 /* Ch.period */ ||
      next == 91 /* Ch.bracketL */ || next == 58 /* Ch.colon */ ||
      next == 45 /* Ch.dash */
    ) {
...
const lessHighlighting = /*@__PURE__*/ styleTags({
  "import charset namespace keyframes media supports when":
...
const parser = /*@__PURE__*/ LRParser.deserialize({
  ...
  specialized: [{ term: 116, get: (value) => spec_identifier[value] || -1 }, {
    term: 23,
...
source.
*/
const lessCompletionSource = /*@__PURE__*/ defineCSSCompletionSource((node) =>
  node.name == "VariableName" || node.name == "AtKeyword"
);
/**
...
function less() {
  return new LanguageSupport(
    lessLanguage,
    lessLanguage.data.of({ autocomplete: lessCompletionSource }),
  );
}

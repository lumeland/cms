import { initializeImageMagick } from "https://cdn.jsdelivr.net/npm/@imagemagick/magick-wasm@0.0.38/dist/index.js";
import {
  ImageMagick,
  MagickFormat,
  MagickGeometry,
} from "https://cdn.jsdelivr.net/npm/@imagemagick/magick-wasm@0.0.38/dist/index.js";
import type {
  IMagickImage,
  MagickFormat as IMagickFormat,
} from "https://cdn.jsdelivr.net/npm/@imagemagick/magick-wasm@0.0.38/dist/index.d.ts";
...
async function initialize() {
  const wasmUrl = new URL(
    "https://cdn.jsdelivr.net/npm/@imagemagick/magick-wasm@0.0.38/dist/magick.wasm",
  );

...
export default function (app: Hono) {
    ...
    app.get("/collection/:collection/edit/:document", async (c: Context) => {
        ...
        const initViews =
            typeof collectionViews === "function"
                ? collectionViews() || []
                : collectionViews || []
    ...
    app.get("/collection/:collection/code/:document", async (c: Context) => {
        ...
        try {
            console.log("test: collection data:", collection)
    ...
    app.post("/collection/:collection/delete/:document", async (c: Context) => {
        ...
        return c.redirect(
            getPath(options.basePath, "collection", collection.name)
        )
    })

    app.get("/collection/:collection/create", async (c: Context) => {
